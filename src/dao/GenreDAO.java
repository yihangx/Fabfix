...
//	}
	...
	private static Connection getConnectionPool(boolean write) throws SQLException, NamingException {
		Connection conn = ConnectionFactory.getInstance().getConnectionPool(write);
		return conn;
	}
...
//			connection = getConnection();
			connection = getConnectionPool(true);
...
//            	System.out.println("insert a new genre: " + name);
	...
	public int getIdFromName(String name) {
		...
		try {
//			connection = getConnection();
			connection = getConnectionPool(false);
			statement = connection.createStatement();
